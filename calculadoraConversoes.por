		...
		faca
		{
			...
			escolha(tipoConversor)
			{
				...
				caso 2:
					...
					pare
				//Se o tipo for 3 informamos que a aplicação será encerrada pelo próprio usuário
				caso 3:
					//Aqu informamos a mensagem de finalizaçãp da aplicação
					mensagem = "Aplicação encerrada pelo próprio usuário"
					pare
				caso contrario:
